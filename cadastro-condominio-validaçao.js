...
//Set verificação de erro ao fazer submit
        bodyinput.addEventListener('submit', (event) =>{
        ...
        //Funções para setar mensagem de erro e remover mensagem de erro se estiver tudo dentro dos conformes
